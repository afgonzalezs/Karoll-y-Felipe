export const siteContent = {
  coupleNames: "Felipe y Karoll",
  hero: {
    eyebrow: "¡Nos casamos!",
    title: "Felipe & Karoll",
    dateLabel: "21.09.2026 💫",
    subtitle: "Nos dijimos sí a compartir la vida."
  },
  story: {
    paragraphs: [
  ...
  location: {
    mapEmbedUrl: "https://www.google.com/maps?q=4.6534757,-74.0585037&output=embed",
    mapsUrl: "https://maps.app.goo.gl/eurm2bCKdAeNQK2i6",
    indications: "Llegar 10 minutos antes. Los esperamos con mucho amor."
  },
  dressCode: {
  ...
  gifts: {
    ...
    lines: [
      "Tenerte junto a nosotros en este día tan especial significa todo 🤍",
      "Durante la recepción contaremos con un espacio destinado para lluvia de sobres. 💌"
    ]
  },
  finalMessage:
